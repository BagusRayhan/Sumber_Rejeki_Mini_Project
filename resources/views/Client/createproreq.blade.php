...
<script>
  ...
  $('.input-icon').click(function() {
    $(this).siblings('.dropdown-menu').toggle();
                            ...
                            <div class="form-group">
                                <label for="input2">Fitur 2</label>
                                <input type="text" class="form-control" id="input2" placeholder="Add fitur">
                            </div><br>
                            <div class="form-group">
                                <label for="input3">Fitur 3</label>
                                <input type="text" class="form-control" id="input3" placeholder="Add fitur">
                            </div><br>
                            <div class="form-group">
                                <label for="input4">Fitur 4</label>
                                <input type="text" class="form-control" id="input4" placeholder="Add fitur">
                            </div><br>
                            <center>
                            <button type="submit" class="btn btn-primary">Kirim Request</button><br><br>
                            <a  href="http://127.0.0.1:8000/drequestclient">Kembali</a></center>
