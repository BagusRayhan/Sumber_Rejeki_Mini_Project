            ...
            <nav class="navbar  navbar-light" >
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <div class="nav-item dropdown">
                        <a href="{{ route('drequestclient') }}" class="nav-link dropdown-toggle {{ Request::routeIs('drequestclient*','setujuclient*','selesaiclient*','revisiclient*','ditolakclient*','revisibutton*','detail-revisi-client*','*detailsetujui','createproreq*','editproreq*') ? 'active' : '' }}" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Project</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('drequestclient') }}" class="dropdown-item py-2 px-5 fw-medium {{ Request::routeIs('drequestclient*','createproreq*','editproreq*') ? 'text-primary' : '' }}">Project Request</a>
