  ...
  <div class="container-login100" style="background-image: url('{{ asset('ProjectManagement/dashmin/img/bgl.png') }}');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
      <form class="login100-form validate-form" action="{{ route('postlogin') }}" method="POST">
        ...
        @if ($errors->any())
    <div class="alert alert-danger" style="max-width: 400px; overflow: hidden;">
        <ul>
...
@endif
            @if (session('status'))
                <div class="alert alert-success">
                    ...
                    @endif
                    @if (session('error'))
    <div class="alert alert-danger" style="max-width: 700px; overflow: hidden; word-wrap: break-word;">
        {{ session('error') }}
    </div>
@endif
