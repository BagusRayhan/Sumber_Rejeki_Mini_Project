    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img class="rounded-circle me-lg-2 profile-image" src="{{ asset('gambar/user-profile/'. $admin->profil) }}" alt="" style="width: 40px; height: 40px;">
            </a>
      ...
      <div class="modal-body">
        <form action="{{ route('admin.updateProfile') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="profile d-flex justify-content-center">
                <img src="/gambar/user-profile/{{ $admin->profil }}" class="rounded-circle profile-image" id="profile-pic">
